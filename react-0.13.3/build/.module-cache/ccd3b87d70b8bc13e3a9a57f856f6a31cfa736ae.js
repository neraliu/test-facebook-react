  ...
  render: function() {
    return (
      React.createElement("div", {className: "comment"}, 
        ...
        React.createElement("h3", {class: "{this.props.author}"}, this.props.author), 
        React.createElement("h3", {class: "{this.props.author}"}, this.props.author), 
        React.createElement("h3", {class: this.props.author}, this.props.author), 
	...
	React.createElement("a", {href: "{this.props.author}"}, "link")
      )
    );
  }
});
...
var data = [
  {author: "Pete Hunt x:expression(0); ;:[]{}()", text: "This is one comment"},
  {author: "alert(0);", text: "This is *another* comment"}
];
